        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <a href="<?= base_url('pelanggan/c_orderdetail/order/'.$_GET['order']) ?>" class="btn btn-danger btn-block">Cancel</a>
                    <?php endif;?>
                </form>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php endif;?>
                                    ...
                                    <?php else :?>
                                    <td>
                                    <a href="<?= base_url('pelanggan/c_orderdetail/deleteOrder/'.$a['id_detail_order'].'/?order='.$a['id_order']) ?>" onclick="return confirm('Yakin ingin menghapus data? Data yang dihapus tidak bisa dikembalikan.')" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                    <a href="<?= base_url('pelanggan/c_orderdetail/editOrder/'.$a['id_detail_order'].'/?order='.$a['id_order']) ?>" class="btn btn-success"><i class="fa fa-pen"></i></a>
                                    </td>
                                    <?php endif ;?>
