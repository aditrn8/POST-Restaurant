                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php endif;?>
                                    ...
                                    <?php else :?>
                                    <td>
                                    <a href="<?= base_url('admin/c_order/deleteOrder/'.$a['id_detail_order'].'/?order='.$a['id_order']) ?>" onclick="return confirm('Yakin ingin menghapus data? Data yang dihapus tidak bisa dikembalikan.')" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                    <a href="<?= base_url('admin/c_order/editOrder/'.$a['id_detail_order'].'/?order='.$a['id_order']) ?>" class="btn btn-success"><i class="fa fa-pen"></i></a>
                                    </td>
                                    <?php endif ;?>
